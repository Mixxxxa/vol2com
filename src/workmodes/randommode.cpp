...
public:
        ...
        m_counter(0)
    {
        ...
        QObject::connect(&m_reverseTimer, &QTimer::timeout, [this]()
        {
            m_reverse = !m_reverse;
    ...
    {
        auto color = QColor::fromHsv(m_hue.value(), 255, 255);
    ...
    std::chrono::seconds getTimerDuration() const
    {
        constexpr int Min = 10;
        constexpr int Max = 30;
        return std::chrono::seconds((std::rand() % (Max-Min)) + Min);
    }
